        ...
        if(satellite.isTouching(pluto))
        {
          gameState = END2;
            ...
            if(gameState === END2)
            {
              ...
              var rock = createSprite(camera.position.x-100, camera.position.y-100, 30, 30);
              rock.scale = 2;
              ...
              textSize(30);
              fill("CYAN");
              text("The rock can be used to make a multi-nuclear misslie", camera.position.x-200, camera.position.y+30);

              textSize(30);
              fill("CYAN");
              text("Which could destroy 12 Countries at a time...", camera.position.x-200, camera.position.y+60);
              satellite.hide();
            }
